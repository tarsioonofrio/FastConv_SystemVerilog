...
add wave -noupdate /tb/conv_naive/clk
add wave -noupdate /tb/conv_naive/reset
add wave -noupdate /tb/conv_naive/start
add wave -noupdate /tb/conv_naive/data_valid
add wave -noupdate -radix decimal /tb/conv_naive/prod
...
add wave -noupdate /tb/conv_naive/cont_state
add wave -noupdate /tb/conv_naive/start_mac
add wave -noupdate /tb/conv_naive/done_mac
add wave -noupdate /tb/conv_naive/EA
