...
module Conv
  #(
    ...
    parameter int unsigned STATE_MULT          = 3
  ) (
    input  logic clk,
    input  logic reset,
    input  logic p_start,
  ...
  // This source is the fixed twelve-MAC IF3x3 implementation.  NUM_MULT and
  // STATE_MULT remain compatibility parameters for the shared testbench.
  localparam int unsigned FIXED_NUM_MULT = 12;
  localparam int unsigned FIXED_STATE_MULT = 3;
