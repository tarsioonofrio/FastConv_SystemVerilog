...
module Conv
  #(
    ...
    // Compatibility parameter for the shared testbench; hardware stays fixed at two MACs.
  ...
  localparam int unsigned FIXED_NUM_MULT = 2;
...
`endif
  ...
  always_ff @(posedge clk or posedge reset) begin: WEIGHT_REG_BLOCK
    ...
    end else if (st_conv_current == HADAMARD) begin         // rotate two active weights
      r_input_weight[0]  <= r_input_weight[2];
      r_input_weight[1]  <= r_input_weight[3];
      r_input_weight[2]  <= r_input_weight[4];
      r_input_weight[3]  <= r_input_weight[5];
      r_input_weight[4]  <= r_input_weight[6];
      r_input_weight[5]  <= r_input_weight[7];
      r_input_weight[6]  <= r_input_weight[8];
      r_input_weight[7]  <= r_input_weight[9];
      r_input_weight[8]  <= r_input_weight[10];
      r_input_weight[9]  <= r_input_weight[11];
      r_input_weight[10] <= r_input_weight[12];
      r_input_weight[11] <= r_input_weight[13];
      r_input_weight[12] <= r_input_weight[14];
      r_input_weight[13] <= r_input_weight[15];
      r_input_weight[14] <= r_input_weight[0];
      r_input_weight[15] <= r_input_weight[1];
    end
  end
...
`endif
  ...
  assign w_stream_product_row[0] = (r_stream_product_idx[1:0] == 0) ? w_conv_product[0] : r_s_row[0];
  assign w_stream_product_row[1] = (r_stream_product_idx[1:0] == 0) ? w_conv_product[1] : r_s_row[1];
  assign w_stream_product_row[2] = (r_stream_product_idx[1:0] == 2) ? w_conv_product[0] : r_s_row[2];
  assign w_stream_product_row[3] = (r_stream_product_idx[1:0] == 2) ? w_conv_product[1] : r_s_row[3];
