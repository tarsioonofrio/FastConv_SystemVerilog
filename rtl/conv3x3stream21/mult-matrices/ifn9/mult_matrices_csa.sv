...
module MatrixC0 #(
  ...
  assign sp28 = P[22];
  assign sp29 = P[23];
  CSA_2 #(.NBITS(NBITS)) csa_n0(P[1], P[2], sn0);
  CSA_2 #(.NBITS(NBITS)) csa_n1(P[1], P[3], sn1);
  CSA_2 #(.NBITS(NBITS)) csa_n2(P[2], P[3], sn2);
  CSA_2 #(.NBITS(NBITS)) csa_n6(P[6], P[7], sn6);
  CSA_2 #(.NBITS(NBITS)) csa_n7(P[6], P[8], sn7);
  CSA_2 #(.NBITS(NBITS)) csa_n8(P[7], P[8], sn8);
  CSA_2 #(.NBITS(NBITS)) csa_n12(P[11], P[12], sn12);
  CSA_2 #(.NBITS(NBITS)) csa_n13(P[11], P[13], sn13);
  CSA_2 #(.NBITS(NBITS)) csa_n14(P[12], P[13], sn14);
  CSA_2 #(.NBITS(NBITS)) csa_n18(P[16], P[17], sn18);
  CSA_2 #(.NBITS(NBITS)) csa_n19(P[16], P[18], sn19);
  CSA_2 #(.NBITS(NBITS)) csa_n20(P[17], P[18], sn20);
  CSA_2 #(.NBITS(NBITS)) csa_n24(P[21], P[22], sn24);
  CSA_2 #(.NBITS(NBITS)) csa_n25(P[21], P[23], sn25);
  CSA_2 #(.NBITS(NBITS)) csa_n26(P[22], P[23], sn26);
...
module MatrixC1 #(
  ...
  assign sp34 = P[22];
  assign sp35 = P[23];
  CSA_2 #(.NBITS(NBITS)) csa_n0(P[6], P[12], sn0);
  CSA_2 #(.NBITS(NBITS)) csa_n1(P[7], P[13], sn1);
  CSA_2 #(.NBITS(NBITS)) csa_n2(P[8], P[14], sn2);
  CSA_2 #(.NBITS(NBITS)) csa_n3(P[9], P[15], sn3);
  CSA_2 #(.NBITS(NBITS)) csa_n4(P[10], P[16], sn4);
  CSA_2 #(.NBITS(NBITS)) csa_n5(P[11], P[17], sn5);
  CSA_2 #(.NBITS(NBITS)) csa_n6(P[6], P[18], sn6);
  CSA_2 #(.NBITS(NBITS)) csa_n7(P[7], P[19], sn7);
  CSA_2 #(.NBITS(NBITS)) csa_n8(P[8], P[20], sn8);
  CSA_2 #(.NBITS(NBITS)) csa_n9(P[9], P[21], sn9);
  CSA_2 #(.NBITS(NBITS)) csa_n10(P[10], P[22], sn10);
  CSA_2 #(.NBITS(NBITS)) csa_n11(P[11], P[23], sn11);
  CSA_2 #(.NBITS(NBITS)) csa_n12(P[12], P[18], sn12);
  CSA_2 #(.NBITS(NBITS)) csa_n13(P[13], P[19], sn13);
  CSA_2 #(.NBITS(NBITS)) csa_n14(P[14], P[20], sn14);
  CSA_2 #(.NBITS(NBITS)) csa_n15(P[15], P[21], sn15);
  CSA_2 #(.NBITS(NBITS)) csa_n16(P[16], P[22], sn16);
  CSA_2 #(.NBITS(NBITS)) csa_n17(P[17], P[23], sn17);
  assign soma[0] = sp0 - sn0;
  assign soma[1] = sp1 - sn1;
  assign soma[2] = sp2 - sn2;
...
module MatrixA1 #(
  ...
  CSA_3 #(.NBITS(NBITS)) csa_p2(P[2], P[4], P[5], sp2);
  CSA_3 #(.NBITS(NBITS)) csa_p3(P[6], P[9], P[10], sp3);
  CSA_3 #(.NBITS(NBITS)) csa_p4(P[7], P[9], P[11], sp4);
  CSA_3 #(.NBITS(NBITS)) csa_p5(P[8], P[10], P[11], sp5);
  CSA_3 #(.NBITS(NBITS)) csa_p6(P[12], P[15], P[16], sp6);
  CSA_3 #(.NBITS(NBITS)) csa_p7(P[13], P[15], P[17], sp7);
  CSA_3 #(.NBITS(NBITS)) csa_p8(P[14], P[16], P[17], sp8);
  CSA_3 #(.NBITS(NBITS)) csa_p9(P[18], P[21], P[22], sp9);
  CSA_3 #(.NBITS(NBITS)) csa_p10(P[19], P[21], P[23], sp10);
  CSA_3 #(.NBITS(NBITS)) csa_p11(P[20], P[22], P[23], sp11);
  CSA_3 #(.NBITS(NBITS)) csa_p12(P[24], P[27], P[28], sp12);
  CSA_3 #(.NBITS(NBITS)) csa_p13(P[25], P[27], P[29], sp13);
  CSA_3 #(.NBITS(NBITS)) csa_p14(P[26], P[28], P[29], sp14);
  CSA_3 #(.NBITS(NBITS)) csa_p15(P[30], P[33], P[34], sp15);
  CSA_3 #(.NBITS(NBITS)) csa_p16(P[31], P[33], P[35], sp16);
  CSA_3 #(.NBITS(NBITS)) csa_p17(P[32], P[34], P[35], sp17);
  assign soma[0] = sp0;
  assign soma[1] = sp1;
  assign soma[2] = sp2;
  assign soma[3] = sp3;
...
module MatrixA0 #(
  ...
  CSA_3 #(.NBITS(NBITS)) csa_p2(P[2], P[11], P[14], sp2);
  CSA_3 #(.NBITS(NBITS)) csa_p3(P[3], P[9], P[15], sp3);
  CSA_3 #(.NBITS(NBITS)) csa_p4(P[4], P[10], P[16], sp4);
  CSA_3 #(.NBITS(NBITS)) csa_p5(P[5], P[11], P[17], sp5);
  CSA_3 #(.NBITS(NBITS)) csa_p6(P[6], P[12], P[15], sp6);
  CSA_3 #(.NBITS(NBITS)) csa_p7(P[7], P[13], P[16], sp7);
  CSA_3 #(.NBITS(NBITS)) csa_p8(P[8], P[14], P[17], sp8);
  assign soma[0] = sp0;
  assign soma[1] = sp1;
  assign soma[2] = sp2;
  assign soma[3] = sp3;
