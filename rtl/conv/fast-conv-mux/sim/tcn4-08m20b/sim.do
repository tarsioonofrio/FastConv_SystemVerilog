...
if {[info exists ::env(DATA)]} {
    ...
    set DATA_SV "../../../../../data/tcn4/data.sv"
}
vlog -work work  $DATA_SV
vlog -work work  ./pack_conv.sv
vlog -work work -svinputport=relaxed ../../../../csa/csa_lib.sv
vlog -work work -svinputport=relaxed ../../../../mult-matrices/tcn4/mult_matrices.sv
vlog -work work -svinputport=relaxed ../../../../mux-mult/tcn4/mux_mult_08.sv
