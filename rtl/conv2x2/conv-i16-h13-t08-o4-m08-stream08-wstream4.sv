      ...
      unique case (st_conv_current)
        TRANSFORM: begin
          ...
          if (r_weight_tile_valid) begin
            r_input_weight[0] <= w_weight_row_first[0]; r_input_weight[1] <= w_weight_row_first[1];
            r_input_weight[2] <= w_weight_row_first[2]; r_input_weight[3] <= w_weight_row_first[3];
