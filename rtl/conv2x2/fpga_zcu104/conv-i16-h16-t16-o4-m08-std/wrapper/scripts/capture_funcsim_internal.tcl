...
run
puts "WRAPPER_P3F_INTERNAL_CAPTURE_STARTED"
dumpsaif -scope tb_fpga_wrapper_funcsim.dut -internal -divider / -overwrite -output activity_internal.saif
stop -condition {#%d/tb_fpga_wrapper_funcsim/capture_done == 1'b1}
stop -time 90 us -execute {puts "WRAPPER_P3F_INTERNAL_TIMEOUT"; exit}
run
puts "WRAPPER_P3F_INTERNAL_CAPTURE_ENDED"
dumpsaif -end
run
quit
