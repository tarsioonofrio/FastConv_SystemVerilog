...
run
puts "P3F_DUT_CAPTURE_STARTED"
dumpsaif -scope tb_power.dut -internal -memories -divider / -overwrite -output activity_timesim.saif
stop -condition {#%d/tb_power/p_end == 1}
stop -time 90 us -execute {puts "P3F_DUT_TIMEOUT_BEFORE_P_END"; exit}
run
puts "P3F_DUT_CAPTURE_ENDED"
dumpsaif -end
