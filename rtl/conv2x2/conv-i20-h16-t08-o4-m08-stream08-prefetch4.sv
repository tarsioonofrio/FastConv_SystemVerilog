...
`endif
  ...
  always_ff @(posedge clk or posedge reset) begin: WEIGHT_REG_BLOCK
    if (reset) begin
      ...
      r_input_weight[0] <= r_input_weight[8]; r_input_weight[1] <= r_input_weight[9];
      r_input_weight[2] <= r_input_weight[10]; r_input_weight[3] <= r_input_weight[11];
      r_input_weight[4] <= r_input_weight[12]; r_input_weight[5] <= r_input_weight[13];
      r_input_weight[6] <= r_input_weight[14]; r_input_weight[7] <= r_input_weight[15];
      r_input_weight[8] <= r_input_weight[0]; r_input_weight[9] <= r_input_weight[1];
      r_input_weight[10] <= r_input_weight[2]; r_input_weight[11] <= r_input_weight[3];
      r_input_weight[12] <= r_input_weight[4]; r_input_weight[13] <= r_input_weight[5];
      r_input_weight[14] <= r_input_weight[6]; r_input_weight[15] <= r_input_weight[7];
    end
  end
