...
module InverseRow #(
  ...
  assign inverse_partial[0] = inverse_input_row[0] + inverse_input_row[1] + inverse_input_row[2];
  assign inverse_partial[1] = inverse_input_row[1] + inverse_input_row[3] - inverse_input_row[2];
endmodule
...
module InverseRowAccumulate #(
  ...
  always_comb begin
    ...
    unique case (inverse_row_idx)
      0: begin accumulator_out[0] = inverse_partial[0]; accumulator_out[1] = inverse_partial[1]; end
      1: begin
        accumulator_out[0] = accumulator_in[0] + inverse_partial[0]; accumulator_out[1] = accumulator_in[1] + inverse_partial[1];
        accumulator_out[2] = inverse_partial[0]; accumulator_out[3] = inverse_partial[1];
      end
      2: begin
        accumulator_out[0] = accumulator_in[0] + inverse_partial[0]; accumulator_out[1] = accumulator_in[1] + inverse_partial[1];
        accumulator_out[2] = accumulator_in[2] - inverse_partial[0]; accumulator_out[3] = accumulator_in[3] - inverse_partial[1];
      end
      3: begin accumulator_out[2] = accumulator_in[2] + inverse_partial[0]; accumulator_out[3] = accumulator_in[3] + inverse_partial[1]; end
      default: begin end
    endcase
  end
endmodule
