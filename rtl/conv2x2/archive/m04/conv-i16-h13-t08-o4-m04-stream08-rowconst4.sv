...
module Conv
  ...
  logic [NBITS-1:0] w_weight_row0 [FIXED_NUM_MULT-1:0];
  logic [NBITS-1:0] w_weight_row1 [FIXED_NUM_MULT-1:0];
  logic [NBITS-1:0] w_weight_row2 [FIXED_NUM_MULT-1:0];
  logic [NBITS-1:0] w_weight_row3 [FIXED_NUM_MULT-1:0];
