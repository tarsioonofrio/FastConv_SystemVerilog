...
module Conv
  ...
  logic signed [WEIGHT_NBITS-1:0] w_weight_row3 [FIXED_NUM_MULT-1:0];
      ...
      unique case (st_conv_current)
        TRANSFORM: begin
          ...
          if (r_weight_tile_valid) begin
            r_input_weight[0] <= w_weight_row[0];
            r_input_weight[1] <= w_weight_row[1];
            r_input_weight[2] <= w_weight_row[2];
            r_input_weight[3] <= w_weight_row[3];
          end
          r_inverse_row              <= '{default: '0};
          r_output_write              <= '{default: '0};
          r_inverse_row_idx     <= '0;
  ...
  always_comb begin: WEIGHT_ROW_ENABLE_BLOCK
    ...
    if ((st_conv_current == TRANSFORM) && r_weight_tile_valid) begin
      ...
      case (w_weight_row_index_next)
        2'd1: w_weight_row_enable1 = 1'b1;
        2'd2: w_weight_row_enable2 = 1'b1;
        2'd3: w_weight_row_enable3 = 1'b1;
        default: begin end
      endcase
    end
  end
