...
`endif
          ...
          end else if (r_transform_product_idx == PRODUCT_INDEX_WIDTH'(4)) begin
          ...
          end else if (r_transform_product_idx == PRODUCT_INDEX_WIDTH'(8)) begin
...
`endif
  ...
  // sequential r_transform_row boundary below consumes one four-word row per cycle,
