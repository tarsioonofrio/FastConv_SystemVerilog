...
module MatrixA0 #(
  ...
  CSA_4 #(.NBITS(NBITS)) csa_p1(P[8], P[12], P[20], P[24], sp1);
  CSA_2 #(.NBITS(NBITS)) csa_p2(P[4], P[8], sp2);
  CSA_3 #(.NBITS(NBITS)) csa_p3(P[8], P[12], P[28], sp3);
  CSA_5 #(.NBITS(NBITS)) csa_p4(P[1], P[5], P[9], P[17], P[21], sp4);
  CSA_4 #(.NBITS(NBITS)) csa_p5(P[9], P[13], P[21], P[25], sp5);
  CSA_2 #(.NBITS(NBITS)) csa_p6(P[5], P[9], sp6);
  CSA_3 #(.NBITS(NBITS)) csa_p7(P[9], P[13], P[29], sp7);
  CSA_5 #(.NBITS(NBITS)) csa_p8(P[2], P[6], P[10], P[18], P[22], sp8);
  CSA_4 #(.NBITS(NBITS)) csa_p9(P[10], P[14], P[22], P[26], sp9);
  CSA_2 #(.NBITS(NBITS)) csa_p10(P[6], P[10], sp10);
  CSA_3 #(.NBITS(NBITS)) csa_p11(P[10], P[14], P[30], sp11);
  CSA_5 #(.NBITS(NBITS)) csa_p12(P[3], P[7], P[11], P[19], P[23], sp12);
  CSA_4 #(.NBITS(NBITS)) csa_p13(P[11], P[15], P[23], P[27], sp13);
  CSA_2 #(.NBITS(NBITS)) csa_p14(P[7], P[11], sp14);
  CSA_3 #(.NBITS(NBITS)) csa_p15(P[11], P[15], P[31], sp15);
  CSA_2 #(.NBITS(NBITS)) csa_n2(P[16], P[20], sn2);
  CSA_2 #(.NBITS(NBITS)) csa_n3(P[20], P[24], sn3);
  CSA_2 #(.NBITS(NBITS)) csa_n6(P[17], P[21], sn6);
  CSA_2 #(.NBITS(NBITS)) csa_n7(P[21], P[25], sn7);
  CSA_2 #(.NBITS(NBITS)) csa_n10(P[18], P[22], sn10);
  CSA_2 #(.NBITS(NBITS)) csa_n11(P[22], P[26], sn11);
  CSA_2 #(.NBITS(NBITS)) csa_n14(P[19], P[23], sn14);
