...
module MatrixA0 #(
  ...
  CSA_2 #(.NBITS(NBITS)) csa_p1(P[4], P[12] <<< 1, sp1);
  CSA_4 #(.NBITS(NBITS)) csa_p2(P[4], P[8], P[12] <<< 2, P[16] <<< 2, sp2);
  CSA_3 #(.NBITS(NBITS)) csa_p3(P[4], P[12] <<< 3, P[20], sp3);
  CSA_5 #(.NBITS(NBITS)) csa_p4(P[1], P[5], P[9], P[13], P[17], sp4);
  CSA_2 #(.NBITS(NBITS)) csa_p5(P[5], P[13] <<< 1, sp5);
  CSA_4 #(.NBITS(NBITS)) csa_p6(P[5], P[9], P[13] <<< 2, P[17] <<< 2, sp6);
  CSA_3 #(.NBITS(NBITS)) csa_p7(P[5], P[13] <<< 3, P[21], sp7);
  CSA_5 #(.NBITS(NBITS)) csa_p8(P[2], P[6], P[10], P[14], P[18], sp8);
  CSA_2 #(.NBITS(NBITS)) csa_p9(P[6], P[14] <<< 1, sp9);
  CSA_4 #(.NBITS(NBITS)) csa_p10(P[6], P[10], P[14] <<< 2, P[18] <<< 2, sp10);
  CSA_3 #(.NBITS(NBITS)) csa_p11(P[6], P[14] <<< 3, P[22], sp11);
  CSA_5 #(.NBITS(NBITS)) csa_p12(P[3], P[7], P[11], P[15], P[19], sp12);
  CSA_2 #(.NBITS(NBITS)) csa_p13(P[7], P[15] <<< 1, sp13);
  CSA_4 #(.NBITS(NBITS)) csa_p14(P[7], P[11], P[15] <<< 2, P[19] <<< 2, sp14);
  CSA_3 #(.NBITS(NBITS)) csa_p15(P[7], P[15] <<< 3, P[23], sp15);
  CSA_2 #(.NBITS(NBITS)) csa_n1(P[8], P[16] <<< 1, sn1);
  CSA_2 #(.NBITS(NBITS)) csa_n3(P[8], P[16] <<< 3, sn3);
  CSA_2 #(.NBITS(NBITS)) csa_n5(P[9], P[17] <<< 1, sn5);
  CSA_2 #(.NBITS(NBITS)) csa_n7(P[9], P[17] <<< 3, sn7);
  CSA_2 #(.NBITS(NBITS)) csa_n9(P[10], P[18] <<< 1, sn9);
  CSA_2 #(.NBITS(NBITS)) csa_n11(P[10], P[18] <<< 3, sn11);
  CSA_2 #(.NBITS(NBITS)) csa_n13(P[11], P[19] <<< 1, sn13);
