package pack_param;
  ...
  // Canonical names consumed by the parameterized conv4x4 controller.
  localparam int CONV_OUTPUT_SIZE = A1_SIZE;
  localparam int CONV_KERNEL_SIZE = B1_SIZE;
  localparam int CONV_INPUT_SIZE = C1_SIZE;
  localparam int HADAMARD_SIZE = M1_SIZE;
