...
add wave -noupdate /tb/p_start_channel
add wave -noupdate /tb/w_start_channel
add wave -noupdate /tb/current_st
...
add wave -noupdate /tb/control/p_start_channel
add wave -noupdate -radix decimal -childformat {{{/tb/control/p_input[24]} -radix decimal} {{/tb/control/p_input[23]} -radix decimal} {{/tb/control/p_input[22]} -radix decimal} {{/tb/control/p_input[21]} -radix decimal} {{/tb/control/p_input[20]} -radix decimal} {{/tb/control/p_input[19]} -radix decimal} {{/tb/control/p_input[18]} -radix decimal} {{/tb/control/p_input[17]} -radix decimal} {{/tb/control/p_input[16]} -radix decimal} {{/tb/control/p_input[15]} -radix decimal} {{/tb/control/p_input[14]} -radix decimal} {{/tb/control/p_input[13]} -radix decimal} {{/tb/control/p_input[12]} -radix decimal} {{/tb/control/p_input[11]} -radix decimal} {{/tb/control/p_input[10]} -radix decimal} {{/tb/control/p_input[9]} -radix decimal} {{/tb/control/p_input[8]} -radix decimal} {{/tb/control/p_input[7]} -radix decimal} {{/tb/control/p_input[6]} -radix decimal} {{/tb/control/p_input[5]} -radix decimal} {{/tb/control/p_input[4]} -radix decimal} {{/tb/control/p_input[3]} -radix decimal} {{/tb/control/p_input[2]} -radix decimal} {{/tb/control/p_input[1]} -radix decimal} {{/tb/control/p_input[0]} -radix decimal}} -subitemconfig {{/tb/control/p_input[24]} {-height 16 -radix decimal} {/tb/control/p_input[23]} {-height 16 -radix decimal} {/tb/control/p_input[22]} {-height 16 -radix decimal} {/tb/control/p_input[21]} {-height 16 -radix decimal} {/tb/control/p_input[20]} {-height 16 -radix decimal} {/tb/control/p_input[19]} {-height 16 -radix decimal} {/tb/control/p_input[18]} {-height 16 -radix decimal} {/tb/control/p_input[17]} {-height 16 -radix decimal} {/tb/control/p_input[16]} {-height 16 -radix decimal} {/tb/control/p_input[15]} {-height 16 -radix decimal} {/tb/control/p_input[14]} {-height 16 -radix decimal} {/tb/control/p_input[13]} {-height 16 -radix decimal} {/tb/control/p_input[12]} {-height 16 -radix decimal} {/tb/control/p_input[11]} {-height 16 -radix decimal} {/tb/control/p_input[10]} {-height 16 -radix decimal} {/tb/control/p_input[9]} {-height 16 -radix decimal} {/tb/control/p_input[8]} {-height 16 -radix decimal} {/tb/control/p_input[7]} {-height 16 -radix decimal} {/tb/control/p_input[6]} {-height 16 -radix decimal} {/tb/control/p_input[5]} {-height 16 -radix decimal} {/tb/control/p_input[4]} {-height 16 -radix decimal} {/tb/control/p_input[3]} {-height 16 -radix decimal} {/tb/control/p_input[2]} {-height 16 -radix decimal} {/tb/control/p_input[1]} {-height 16 -radix decimal} {/tb/control/p_input[0]} {-height 16 -radix decimal}} /tb/control/p_input
...
add wave -noupdate -radix unsigned /tb/control/r_window_in_channel
add wave -noupdate -radix unsigned /tb/control/r_window_in_total
...
add wave -noupdate /tb/control/w_end_channel_in
...
add wave -noupdate /tb/dut/p_sum
add wave -noupdate -radix decimal -childformat {{{/tb/dut/p_input[8]} -radix decimal} {{/tb/dut/p_input[7]} -radix decimal} {{/tb/dut/p_input[6]} -radix decimal} {{/tb/dut/p_input[5]} -radix decimal} {{/tb/dut/p_input[4]} -radix decimal} {{/tb/dut/p_input[3]} -radix decimal} {{/tb/dut/p_input[2]} -radix decimal} {{/tb/dut/p_input[1]} -radix decimal} {{/tb/dut/p_input[0]} -radix decimal}} -subitemconfig {{/tb/dut/p_input[8]} {-height 16 -radix decimal} {/tb/dut/p_input[7]} {-height 16 -radix decimal} {/tb/dut/p_input[6]} {-height 16 -radix decimal} {/tb/dut/p_input[5]} {-height 16 -radix decimal} {/tb/dut/p_input[4]} {-height 16 -radix decimal} {/tb/dut/p_input[3]} {-height 16 -radix decimal} {/tb/dut/p_input[2]} {-height 16 -radix decimal} {/tb/dut/p_input[1]} {-height 16 -radix decimal} {/tb/dut/p_input[0]} {-height 16 -radix decimal}} /tb/dut/p_input
add wave -noupdate -radix decimal -childformat {{{/tb/dut/p_output[8]} -radix decimal} {{/tb/dut/p_output[7]} -radix decimal} {{/tb/dut/p_output[6]} -radix decimal} {{/tb/dut/p_output[5]} -radix decimal} {{/tb/dut/p_output[4]} -radix decimal} {{/tb/dut/p_output[3]} -radix decimal} {{/tb/dut/p_output[2]} -radix decimal} {{/tb/dut/p_output[1]} -radix decimal} {{/tb/dut/p_output[0]} -radix decimal}} -subitemconfig {{/tb/dut/p_output[8]} {-height 16 -radix decimal} {/tb/dut/p_output[7]} {-height 16 -radix decimal} {/tb/dut/p_output[6]} {-height 16 -radix decimal} {/tb/dut/p_output[5]} {-height 16 -radix decimal} {/tb/dut/p_output[4]} {-height 16 -radix decimal} {/tb/dut/p_output[3]} {-height 16 -radix decimal} {/tb/dut/p_output[2]} {-height 16 -radix decimal} {/tb/dut/p_output[1]} {-height 16 -radix decimal} {/tb/dut/p_output[0]} {-height 16 -radix decimal}} /tb/dut/p_output
add wave -noupdate /tb/dut/p_read_en
add wave -noupdate -radix unsigned /tb/dut/p_read_addr
add wave -noupdate -radix decimal -childformat {{{/tb/dut/p_read_data[19]} -radix decimal} {{/tb/dut/p_read_data[18]} -radix decimal} {{/tb/dut/p_read_data[17]} -radix decimal} {{/tb/dut/p_read_data[16]} -radix decimal} {{/tb/dut/p_read_data[15]} -radix decimal} {{/tb/dut/p_read_data[14]} -radix decimal} {{/tb/dut/p_read_data[13]} -radix decimal} {{/tb/dut/p_read_data[12]} -radix decimal} {{/tb/dut/p_read_data[11]} -radix decimal} {{/tb/dut/p_read_data[10]} -radix decimal} {{/tb/dut/p_read_data[9]} -radix decimal} {{/tb/dut/p_read_data[8]} -radix decimal} {{/tb/dut/p_read_data[7]} -radix decimal} {{/tb/dut/p_read_data[6]} -radix decimal} {{/tb/dut/p_read_data[5]} -radix decimal} {{/tb/dut/p_read_data[4]} -radix decimal} {{/tb/dut/p_read_data[3]} -radix decimal} {{/tb/dut/p_read_data[2]} -radix decimal} {{/tb/dut/p_read_data[1]} -radix decimal} {{/tb/dut/p_read_data[0]} -radix decimal}} -subitemconfig {{/tb/dut/p_read_data[19]} {-height 16 -radix decimal} {/tb/dut/p_read_data[18]} {-height 16 -radix decimal} {/tb/dut/p_read_data[17]} {-height 16 -radix decimal} {/tb/dut/p_read_data[16]} {-height 16 -radix decimal} {/tb/dut/p_read_data[15]} {-height 16 -radix decimal} {/tb/dut/p_read_data[14]} {-height 16 -radix decimal} {/tb/dut/p_read_data[13]} {-height 16 -radix decimal} {/tb/dut/p_read_data[12]} {-height 16 -radix decimal} {/tb/dut/p_read_data[11]} {-height 16 -radix decimal} {/tb/dut/p_read_data[10]} {-height 16 -radix decimal} {/tb/dut/p_read_data[9]} {-height 16 -radix decimal} {/tb/dut/p_read_data[8]} {-height 16 -radix decimal} {/tb/dut/p_read_data[7]} {-height 16 -radix decimal} {/tb/dut/p_read_data[6]} {-height 16 -radix decimal} {/tb/dut/p_read_data[5]} {-height 16 -radix decimal} {/tb/dut/p_read_data[4]} {-height 16 -radix decimal} {/tb/dut/p_read_data[3]} {-height 16 -radix decimal} {/tb/dut/p_read_data[2]} {-height 16 -radix decimal} {/tb/dut/p_read_data[1]} {-height 16 -radix decimal} {/tb/dut/p_read_data[0]} {-height 16 -radix decimal}} /tb/dut/p_read_data
...
add wave -noupdate -radix decimal -childformat {{{/tb/dut/r_feat_data[8]} -radix decimal} {{/tb/dut/r_feat_data[7]} -radix decimal} {{/tb/dut/r_feat_data[6]} -radix decimal} {{/tb/dut/r_feat_data[5]} -radix decimal} {{/tb/dut/r_feat_data[4]} -radix decimal} {{/tb/dut/r_feat_data[3]} -radix decimal} {{/tb/dut/r_feat_data[2]} -radix decimal} {{/tb/dut/r_feat_data[1]} -radix decimal} {{/tb/dut/r_feat_data[0]} -radix decimal}} -expand -subitemconfig {{/tb/dut/r_feat_data[8]} {-height 16 -radix decimal} {/tb/dut/r_feat_data[7]} {-height 16 -radix decimal} {/tb/dut/r_feat_data[6]} {-height 16 -radix decimal} {/tb/dut/r_feat_data[5]} {-height 16 -radix decimal} {/tb/dut/r_feat_data[4]} {-height 16 -radix decimal} {/tb/dut/r_feat_data[3]} {-height 16 -radix decimal} {/tb/dut/r_feat_data[2]} {-height 16 -radix decimal} {/tb/dut/r_feat_data[1]} {-height 16 -radix decimal} {/tb/dut/r_feat_data[0]} {-height 16 -radix decimal}} /tb/dut/r_feat_data
add wave -noupdate -radix decimal -childformat {{{/tb/dut/r_read_data[8]} -radix decimal} {{/tb/dut/r_read_data[7]} -radix decimal} {{/tb/dut/r_read_data[6]} -radix decimal} {{/tb/dut/r_read_data[5]} -radix decimal} {{/tb/dut/r_read_data[4]} -radix decimal} {{/tb/dut/r_read_data[3]} -radix decimal} {{/tb/dut/r_read_data[2]} -radix decimal} {{/tb/dut/r_read_data[1]} -radix decimal} {{/tb/dut/r_read_data[0]} -radix decimal}} -expand -subitemconfig {{/tb/dut/r_read_data[8]} {-height 16 -radix decimal} {/tb/dut/r_read_data[7]} {-height 16 -radix decimal} {/tb/dut/r_read_data[6]} {-height 16 -radix decimal} {/tb/dut/r_read_data[5]} {-height 16 -radix decimal} {/tb/dut/r_read_data[4]} {-height 16 -radix decimal} {/tb/dut/r_read_data[3]} {-height 16 -radix decimal} {/tb/dut/r_read_data[2]} {-height 16 -radix decimal} {/tb/dut/r_read_data[1]} {-height 16 -radix decimal} {/tb/dut/r_read_data[0]} {-height 16 -radix decimal}} /tb/dut/r_read_data
...
WaveRestoreCursors {{Cursor 2} {1756500 ps} 1} {{Cursor 3} {1772500 ps} 1} {{Cursor 3} {1738500 ps} 1} {{Cursor 4} {5196844 ps} 0}
...
update
WaveRestoreZoom {1731068 ps} {1845084 ps}
