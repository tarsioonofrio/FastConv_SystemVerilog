...
WaveRestoreCursors {{Cursor 4} {2224500 ps} 1} {{Cursor 6} {63500 ps} 1} {{Cursor 5} {2271500 ps} 1} {{Cursor 4} {2218845 ps} 1}
...
update
WaveRestoreZoom {2142372 ps} {2228916 ps}
