...
add wave -noupdate -radix decimal -childformat {{{/tb/dut/r_read_data[8]} -radix decimal} {{/tb/dut/r_read_data[7]} -radix decimal} {{/tb/dut/r_read_data[6]} -radix decimal} {{/tb/dut/r_read_data[5]} -radix decimal} {{/tb/dut/r_read_data[4]} -radix decimal} {{/tb/dut/r_read_data[3]} -radix decimal} {{/tb/dut/r_read_data[2]} -radix decimal} {{/tb/dut/r_read_data[1]} -radix decimal} {{/tb/dut/r_read_data[0]} -radix decimal}} -subitemconfig {{/tb/dut/r_read_data[8]} {-height 16 -radix decimal} {/tb/dut/r_read_data[7]} {-height 16 -radix decimal} {/tb/dut/r_read_data[6]} {-height 16 -radix decimal} {/tb/dut/r_read_data[5]} {-height 16 -radix decimal} {/tb/dut/r_read_data[4]} {-height 16 -radix decimal} {/tb/dut/r_read_data[3]} {-height 16 -radix decimal} {/tb/dut/r_read_data[2]} {-height 16 -radix decimal} {/tb/dut/r_read_data[1]} {-height 16 -radix decimal} {/tb/dut/r_read_data[0]} {-height 16 -radix decimal}} /tb/dut/r_read_data
add wave -noupdate -radix decimal -childformat {{{/tb/w_conv_output[8]} -radix decimal} {{/tb/w_conv_output[7]} -radix decimal} {{/tb/w_conv_output[6]} -radix decimal} {{/tb/w_conv_output[5]} -radix decimal} {{/tb/w_conv_output[4]} -radix decimal} {{/tb/w_conv_output[3]} -radix decimal} {{/tb/w_conv_output[2]} -radix decimal} {{/tb/w_conv_output[1]} -radix decimal} {{/tb/w_conv_output[0]} -radix decimal}} -subitemconfig {{/tb/w_conv_output[8]} {-radix decimal} {/tb/w_conv_output[7]} {-radix decimal} {/tb/w_conv_output[6]} {-radix decimal} {/tb/w_conv_output[5]} {-radix decimal} {/tb/w_conv_output[4]} {-radix decimal} {/tb/w_conv_output[3]} {-radix decimal} {/tb/w_conv_output[2]} {-radix decimal} {/tb/w_conv_output[1]} {-radix decimal} {/tb/w_conv_output[0]} {-radix decimal}} /tb/w_conv_output
...
WaveRestoreCursors {{Cursor 4} {2224500 ps} 1} {{Cursor 6} {63500 ps} 1} {{Cursor 5} {2271500 ps} 1}
...
update
WaveRestoreZoom {2252020 ps} {2295292 ps}
