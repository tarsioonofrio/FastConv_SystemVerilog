...
module tb;
    ...
    localparam int unsigned CONV_MULTIPLY_STEPS = 5;
    ...
    // Estímulos
    initial begin
        // for (int unsigned idx = 0; idx < INPUT_MEMORY_SIZE; idx++) begin
        //   input_mem[idx] = '0;
        // end
        // for (int unsigned idx = 0; idx < INPUT_MEMORY_INIT_SIZE; idx++) begin
        //   input_mem[idx] = input_mem_init[idx];
        // end
