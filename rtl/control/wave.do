...
add wave -noupdate -radix decimal /tb/dut/r_count_wh
add wave -noupdate -radix decimal /tb/dut/r_count_fin
add wave -noupdate -radix decimal /tb/dut/r_count_fout
...
add wave -noupdate -radix decimal -childformat {{{/tb/conv/p_output[8]} -radix decimal} {{/tb/conv/p_output[7]} -radix decimal} {{/tb/conv/p_output[6]} -radix decimal} {{/tb/conv/p_output[5]} -radix decimal} {{/tb/conv/p_output[4]} -radix decimal} {{/tb/conv/p_output[3]} -radix decimal} {{/tb/conv/p_output[2]} -radix decimal} {{/tb/conv/p_output[1]} -radix decimal} {{/tb/conv/p_output[0]} -radix decimal}} -expand -subitemconfig {{/tb/conv/p_output[8]} {-radix decimal} {/tb/conv/p_output[7]} {-radix decimal} {/tb/conv/p_output[6]} {-radix decimal} {/tb/conv/p_output[5]} {-radix decimal} {/tb/conv/p_output[4]} {-radix decimal} {/tb/conv/p_output[3]} {-radix decimal} {/tb/conv/p_output[2]} {-radix decimal} {/tb/conv/p_output[1]} {-radix decimal} {/tb/conv/p_output[0]} {-radix decimal}} /tb/conv/p_output
...
WaveRestoreCursors {{Cursor 1} {43955 ns} 1 Red default} {{Cursor 2} {755 ns} 0}
