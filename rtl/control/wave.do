...
add wave -noupdate -expand /tb/dut/r_addr_fin
add wave -noupdate /tb/dut/r_addr_fout_base
add wave -noupdate -expand /tb/dut/r_addr_fout
...
add wave -noupdate -radix symbolic /tb/dut/memory_read/data_valid
add wave -noupdate -radix decimal /tb/dut/memory_read/data
add wave -noupdate -radix decimal /tb/dut/memory_read/r_cycles_latency
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {43955 ns} 1 Red default} {{Cursor 2} {977 ns} 0}
